...
return array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('rkw_etracker') . 'Resources/Public/Icons/tx_rkwetracker_domain_model_reportdownloadsum.gif'
	),
	'interface' => array(
